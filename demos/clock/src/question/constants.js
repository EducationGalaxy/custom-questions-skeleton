...
/** range - represents the 12 hours on the clock, to be used when looping over the clock for
 * svg drawing purposes
 */
export const RANGE = 12

export const MINUTE_TICK_LENGTH = -1.5
export const MINUTE_NUMBER_OFFSET = 5
